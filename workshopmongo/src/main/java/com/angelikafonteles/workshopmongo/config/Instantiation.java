package com.angelikafonteles.workshopmongo.config;
...
import com.angelikafonteles.workshopmongo.dto.AuthorDTO;
import com.angelikafonteles.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "Partiu Viagem", "Vou viajar para Bissau:)", new AuthorDTO(maria));
		Post post2 = new Post(null, sdf.parse("23/03/2018"), "Bom dia", "Nem acredito que estou aqui!", new AuthorDTO(maria));
